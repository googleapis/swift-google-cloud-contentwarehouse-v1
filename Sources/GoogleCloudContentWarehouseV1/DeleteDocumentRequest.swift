...
public struct DeleteDocumentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contentwarehouse.v1.DeleteDocumentRequest"
  }
