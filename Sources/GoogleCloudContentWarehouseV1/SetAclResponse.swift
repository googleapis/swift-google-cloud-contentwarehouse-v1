...
public struct SetAclResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SetAclResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SetAclResponse().with { $0.policy = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contentwarehouse.v1.SetAclResponse"
  }
