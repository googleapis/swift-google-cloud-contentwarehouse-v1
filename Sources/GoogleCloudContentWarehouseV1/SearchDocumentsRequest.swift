  ...
  Sendable
{
  ...
  public enum TotalResultSize: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("TOTAL_RESULT_SIZE_UNSPECIFIED")
      case .estimatedSize: return try container.encode("ESTIMATED_SIZE")
      case .actualSize: return try container.encode("ACTUAL_SIZE")
