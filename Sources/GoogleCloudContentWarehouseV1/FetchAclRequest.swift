  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let projectOwner = CodingKeys(stringValue: "projectOwner")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .projectOwner) {
      self.projectOwner = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.projectOwner, forKey: .projectOwner)
