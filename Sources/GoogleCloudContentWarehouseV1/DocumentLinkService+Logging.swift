...
extension Clients {
  final class DocumentLinkServiceLogging: DocumentLinkServiceStub {
    let inner: any DocumentLinkServiceStub
    let logger: Logger

    public init(_ inner: any DocumentLinkServiceStub, logger: Logger) {
      var logger = logger
      ...
      logger[metadataKey: "gcp.experimental.swift.client"] = "DocumentLinkService"
      self.inner = inner
      self.logger = logger
    }
