...
public struct ListSynonymSetsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListSynonymSetsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSynonymSetsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contentwarehouse.v1.ListSynonymSetsRequest"
  }
