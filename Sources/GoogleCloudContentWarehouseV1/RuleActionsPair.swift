...
public struct RuleActionsPair: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Represents the rule.
  ...
  public var actionOutputs: [ActionOutput] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `RuleActionsPair`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RuleActionsPair().with { $0.rule = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let actionOutputs = CodingKeys(stringValue: "actionOutputs")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contentwarehouse.v1.RuleActionsPair"
  }
