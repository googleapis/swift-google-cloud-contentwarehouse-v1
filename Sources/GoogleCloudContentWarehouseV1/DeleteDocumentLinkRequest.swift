...
public struct DeleteDocumentLinkRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteDocumentLinkRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteDocumentLinkRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contentwarehouse.v1.DeleteDocumentLinkRequest"
  }
