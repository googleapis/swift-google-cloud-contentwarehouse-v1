...
public struct GetDocumentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetDocumentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetDocumentRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contentwarehouse.v1.GetDocumentRequest"
  }
