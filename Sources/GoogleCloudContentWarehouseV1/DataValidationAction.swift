...
public struct DataValidationAction: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var conditions: [Swift.String: Swift.String] = [:]

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `DataValidationAction`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DataValidationAction().with { $0.conditions = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [Swift.String: Swift.String].self, forKey: .conditions)
    {
