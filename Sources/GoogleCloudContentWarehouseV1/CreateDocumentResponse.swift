  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let longRunningOperations = CodingKeys(stringValue: "longRunningOperations")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [GoogleLongRunning.Operation].self, forKey: .longRunningOperations)
    {
      self.longRunningOperations = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.longRunningOperations, forKey: .longRunningOperations)
