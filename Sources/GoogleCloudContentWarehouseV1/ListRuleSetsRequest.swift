...
public struct ListRuleSetsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListRuleSetsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRuleSetsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contentwarehouse.v1.ListRuleSetsRequest"
  }
