...
public struct ListDocumentSchemasRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDocumentSchemasRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDocumentSchemasRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contentwarehouse.v1.ListDocumentSchemasRequest"
  }
