...
public struct FileTypeFilter: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// The type of files to return.
  public var fileType: FileTypeFilter.FileType = FileTypeFilter.FileType()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `FileTypeFilter`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FileTypeFilter().with { $0.fileType = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(FileTypeFilter.FileType.self, forKey: .fileType) {
      self.fileType = value
    }
  ...
  public enum FileType: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      ...
      case .rootFolder: return "ROOT_FOLDER"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "ROOT_FOLDER": self = .rootFolder
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contentwarehouse.v1.FileTypeFilter"
  }
