  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let sourceDocumentReference = CodingKeys(stringValue: "sourceDocumentReference")
    static let targetDocumentReference = CodingKeys(stringValue: "targetDocumentReference")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.sourceDocumentReference = try container.decodeIfPresent(
      DocumentReference.self, forKey: .sourceDocumentReference)
    self.targetDocumentReference = try container.decodeIfPresent(
      DocumentReference.self, forKey: .targetDocumentReference)
    ...
    if let value = try container.decodeIfPresent(DocumentLink.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.sourceDocumentReference, forKey: .sourceDocumentReference)
    try container.encodeIfPresent(self.targetDocumentReference, forKey: .targetDocumentReference)
  ...
  public enum State: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .softDeleted: return try container.encode("SOFT_DELETED")
