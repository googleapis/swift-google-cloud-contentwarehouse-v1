...
public struct CreateDocumentLinkRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// (source_document_id).
  public var documentLink: DocumentLink? = nil
  ...
  /// Initialize a new instance of `CreateDocumentLinkRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateDocumentLinkRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let documentLink = CodingKeys(stringValue: "documentLink")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.documentLink = try container.decodeIfPresent(DocumentLink.self, forKey: .documentLink)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.documentLink, forKey: .documentLink)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contentwarehouse.v1.CreateDocumentLinkRequest"
  }
