...
let package = Package(
  name: "GoogleCloudContentWarehouseV1",
  platforms: [.macOS(.v15)],
  products: [
    .library(name: "GoogleCloudContentWarehouseV1", targets: ["GoogleCloudContentWarehouseV1"])
  ],
  dependencies: [
    ...
    localOrRemotePackage(
      url: "https://github.com/googleapis/swift-google-cloud-documentai-v1",
      path: "generated/swift-google-cloud-documentai-v1",
      from: "0.3.0"
    ),
    localOrRemotePackage(
  ...
  targets: [
    .target(
      ...
      dependencies: [
        ...
        .product(name: "GoogleCloudDocumentAIV1", package: "swift-google-cloud-documentai-v1"),
